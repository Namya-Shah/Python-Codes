...
if a == 'left':
    ...
    if b == 'wait':
        c = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow, one blue. Which colour do you choose? ")
        if c == 'red':
        ...
        print("You get attacked by a angry tout. Game Over!")
else:
