# INSPIRED AND CODE BY KALLE HALLDEN
...
# /Users/neelshah/Desktop/myfile.py
PASSWORD = "123456"
...
if connect == PASSWORD:
    ...
    try:
        conn.execute('''
            CREATE TABLE SAFE (FULL_NAME TEXT PRIMARY KEY NOT NULL,
            NAME TEXT NOT NULL,
    ...
    while True:
        ...
        if input_ == "s":
            ...
            command = 'INSERT TO SAFE (FULL_NAME, NAME, EXTENSION, FILES) VALUES (%s, %s, %s, %s);' %('"' + file_name + '"' , '"' + NAME + '"', '"'+EXTENSION+'"', '"' + file_string + '"')
